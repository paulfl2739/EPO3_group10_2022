...
#  Created by Genus(TM) Synthesis Solution 17.11-s014_1 on Thu Dec 08 15:46:34 CET 2022
...
set_load -pin_load 1.0 [get_ports spc_clk]
...
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports spc_clk]
