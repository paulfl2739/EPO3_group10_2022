...
#  Created by Genus(TM) Synthesis Solution 17.11-s014_1 on Thu Dec 08 16:42:47 CET 2022
...
set_load -pin_load 1.0 [get_ports {gyro_data_out[7]}]
set_load -pin_load 1.0 [get_ports {gyro_data_out[6]}]
set_load -pin_load 1.0 [get_ports {gyro_data_out[5]}]
set_load -pin_load 1.0 [get_ports {gyro_data_out[4]}]
set_load -pin_load 1.0 [get_ports {gyro_data_out[3]}]
set_load -pin_load 1.0 [get_ports {gyro_data_out[2]}]
set_load -pin_load 1.0 [get_ports {gyro_data_out[1]}]
set_load -pin_load 1.0 [get_ports {gyro_data_out[0]}]
...
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {gyro_data_out[7]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {gyro_data_out[6]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {gyro_data_out[5]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {gyro_data_out[4]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {gyro_data_out[3]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {gyro_data_out[2]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {gyro_data_out[1]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {gyro_data_out[0]}]
