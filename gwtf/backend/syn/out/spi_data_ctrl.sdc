...
#  Created by Genus(TM) Synthesis Solution 17.11-s014_1 on Thu Dec 08 15:51:04 CET 2022
...
current_design spi_data_ctrl

create_clock -name "clk" -add -period 30.0 -waveform {0.0 15.0} [get_ports clk]
set_load -pin_load 1.0 [get_ports enable]
set_load -pin_load 1.0 [get_ports {sdi_select[2]}]
set_load -pin_load 1.0 [get_ports {sdi_select[1]}]
set_load -pin_load 1.0 [get_ports {sdi_select[0]}]
...
set_input_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports start_switch]
set_input_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports data_ready]
set_input_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports drdy]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports enable]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {sdi_select[2]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {sdi_select[1]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {sdi_select[0]}]
...
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports start_switch]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports data_ready]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports drdy]
